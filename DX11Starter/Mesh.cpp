...
//void Mesh::CreateMesh(Vertex * vertices, int numVerts, unsigned int * indices, int numInds, ID3D11Device * device)
//{
//	// Increment reference count
//	meshRefCount[this]++;
//
...
//}
//
//void Mesh::LoadMesh(char * objFile, ID3D11Device * device)
//{
//	// Increment reference count
//	meshRefCount[this]++;
//
...
void Mesh::createBuffers(Vertex * vertices, int numVerts, unsigned int * indices, int numInds, ID3D11Device * device)
{
	...
	vertexCount = numVerts; // Assign vertex count
